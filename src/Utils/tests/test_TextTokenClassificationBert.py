...
from src.Utils.TextTokenClassificationBert import text_to_tokenList, LABELS, Token
...
class TestTextToTokens(unittest.TestCase):
    ...
    async def test_textToTokens(self, mock_token_classifier):
        ...
        result_adj = await text_to_tokenList("black white man", LABELS.ADJ)
        ...
        result_noun = await text_to_tokenList("black white man", LABELS.NOUN)
