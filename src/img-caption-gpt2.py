...
image_caption = image_to_text(url)[0]['generated_text']
pp(image_caption)
...
tokens_noun = [token["word"] for token in tokens if token["entity_group"] == "NOUN"]
pp(list(dict.fromkeys(tokens_noun)))
